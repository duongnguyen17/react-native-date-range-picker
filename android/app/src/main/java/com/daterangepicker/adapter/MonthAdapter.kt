package com.daterangepicker.adapter
...
import com.daterangepicker.ui.DayView
import com.daterangepicker.ui.MonthView
import java.util.*
...
class MonthAdapter(private val dataSet: ArrayList<MonthElement>) :
    ...
    var allowDateRangeChanges: Boolean = false
                ...
                if (inUse) {
                    ...
                    if (calendarMode == CalendarMode.SINGLE) {
                        ...
                        if (calSelection == null) {
                            ...
                            if (calSelectionCurrent != null && !isSameDay(
                                    calClick,
                                    calSelectionCurrent
                                )
                            ) {
