package com.daterangepicker.ui
...
class DayView : View {
    ...
    private fun drawDay(canvas: Canvas) {
        ...
        if (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY) {
            paintText.color = ContextCompat.getColor(context, R.color.colorAMCalendarWeekendDay)
            paintTextSelected.color = ContextCompat.getColor(context, R.color.colorAMCalendarWeekendDay)
        } else {
            paintText.color = ContextCompat.getColor(context, R.color.colorAMCalendarDay)
            paintTextSelected.color = ContextCompat.getColor(context, R.color.colorAMCalendarDaySelected)
        }
